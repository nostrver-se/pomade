...
func computeSessionID(group Group, request SignCompleteRequestInner) [32]byte {
...
func buildSighashContextsFromPnonces(group Group, request SignCompleteRequestInner, sessionID [32]byte, pnonces []PublicNonceItem) ([]sighashCtx, bool) {
	...
	return []sighashCtx{{sighash: sighash, ctx: ctx}}, true
}

func createPsigPkgWithNonce(group Group, request SignCompleteRequestInner, share Share, secret types.SecretNonce, pnonces []PublicNonceItem) (*SignCompleteResult, bool) {
...
func verifySessionPkg(group Group, request SignCompleteRequestInner) bool {
	gid := computeGroupID(group)
